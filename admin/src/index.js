...
import { PluginIcon, AdvancedCheckboxIcon, AdvancedInputIcon, AdvancedRadioIcon, AdvancedEnumerationIcon } from './components/PluginIcon';
...
const customFields = [
  ...
  },
  {
    ...
    pluginId: PLUGIN_ID,
    component: () => import("./components/AdvancedEnumeration"),
    intlLabel: {
