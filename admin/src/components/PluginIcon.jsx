...
// Advanced Enumeration Icon - List/Dropdown icon mapping
const AdvancedEnumerationIcon = () => (
  <Box
    style={{
      width: '28px',
      height: '28px',
  ...
  >
    ...
    >
      <rect width="32" height="32" rx="6" fill="#4945FF" fillOpacity="0.1"/>
      <rect x="0.5" y="0.5" width="31" height="31" rx="5.5" stroke="#4945FF" strokeOpacity="0.15"/>
      <path d="M12 11H25V13H12V11ZM12 15H25V17H12V15ZM12 19H25V21H12V19ZM7 11H10V13H7V11ZM7 15H10V17H7V15ZM7 19H10V21H7V19Z" fill="#4945FF"/>
      <mask id="path-4-inside-1_649_89_enum" fill="white">
        <path d="M0 6C0 2.68629 2.68629 0 6 0H10V10H0V6Z"/>
      </mask>
      <path d="M-2 6C-2 1.58172 1.58172 -2 6 -2H10V2H6C3.79086 2 2 3.79086 2 6H-2ZM10 10H0H10ZM-2 10V6C-2 1.58172 1.58172 -2 6 -2V2C3.79086 2 2 3.79086 2 6V10H-2ZM10 0V10V0Z" fill="#4945FF" mask="url(#path-4-inside-1_649_89_enum)"/>
    </svg>
  </Box>
);
