...
const AdvancedColorIcon = () => /* @__PURE__ */ jsx(
  Box,
  {
    style: {
      width: "28px",
...
const customFields = [
  {
    ...
    pluginId: PLUGIN_ID,
    component: () => import("./index-cLPilu5W.mjs"),
    intlLabel: {
  ...
  },
  {
    ...
    pluginId: PLUGIN_ID,
    component: () => import("./index-DXVpJkpj.mjs"),
    intlLabel: {
  ...
  },
  {
    ...
    pluginId: PLUGIN_ID,
    component: () => import("./index-C-A6rX1K.mjs"),
    intlLabel: {
  ...
  },
  {
    ...
    pluginId: PLUGIN_ID,
    component: () => import("./index-BYdUTGX8.mjs"),
    intlLabel: {
  ...
  },
  {
    ...
    pluginId: PLUGIN_ID,
    component: () => import("./index-Djus_suc.mjs"),
    intlLabel: {
  ...
  async registerTrads({ locales }) {
    return Promise.all(
      locales.map(async (locale) => {
        ...
        try {
          const { default: data } = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./translations/en.json": () => import("./en-CJmJkBE0.mjs") }), `./translations/${locale}.json`, 3);
          return { data, locale };
        } catch {
          return { data: {}, locale };
        }
