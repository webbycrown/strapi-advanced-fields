...
const AdvancedColorIcon = () => /* @__PURE__ */ jsxRuntime.jsx(
  designSystem.Box,
  {
    style: {
      width: "28px",
...
const customFields = [
  {
    ...
    pluginId: PLUGIN_ID,
    component: () => Promise.resolve().then(() => require("./index-AT-E0hrg.js")),
    intlLabel: {
  ...
  },
  {
    ...
    pluginId: PLUGIN_ID,
    component: () => Promise.resolve().then(() => require("./index-TmoGbq0j.js")),
    intlLabel: {
  ...
  },
  {
    ...
    pluginId: PLUGIN_ID,
    component: () => Promise.resolve().then(() => require("./index-CCaZAiQR.js")),
    intlLabel: {
  ...
  },
  {
    ...
    pluginId: PLUGIN_ID,
    component: () => Promise.resolve().then(() => require("./index-B6ENZ58R.js")),
    intlLabel: {
  ...
  },
  {
    ...
    pluginId: PLUGIN_ID,
    component: () => Promise.resolve().then(() => require("./index-DW9l5xXR.js")),
    intlLabel: {
  ...
  async registerTrads({ locales }) {
    return Promise.all(
      locales.map(async (locale) => {
        ...
        try {
          const { default: data } = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./translations/en.json": () => Promise.resolve().then(() => require("./en-BPwepUqK.js")) }), `./translations/${locale}.json`, 3);
          return { data, locale };
        } catch {
          return { data: {}, locale };
        }
